namespace DiscriminatedUnion
{
	...
	public static partial class Union
	{
		...
		public static Func<Union<T1>, TReturn> CreateMatch<T1, TReturn>(Func<ICase<T1, TReturn>, TReturn> match) => Item => match(Item.Match<TReturn>());

		public static Func<Union<T1, T2>, TReturn> CreateMatch<T1, T2, TReturn>(Func<ICase<T1, T2, TReturn>, TReturn> match) => Item => match(Item.Match<TReturn>());

		public static Func<Union<T1, T2, T3>, TReturn> CreateMatch<T1, T2, T3, TReturn>(Func<ICase<T1, T2, T3, TReturn>, TReturn> match) => Item => match(Item.Match<TReturn>());

		public static Func<Union<T1, T2, T3, T4>, TReturn> CreateMatch<T1, T2, T3, T4, TReturn>(Func<ICase<T1, T2, T3, T4, TReturn>, TReturn> match) => Item => match(Item.Match<TReturn>());

		public static Func<Union<T1, T2, T3, T4, T5>, TReturn> CreateMatch<T1, T2, T3, T4, T5, TReturn>(Func<ICase<T1, T2, T3, T4, T5, TReturn>, TReturn> match) => Item => match(Item.Match<TReturn>());

		public static Func<Union<T1, T2, T3, T4, T5, T6>, TReturn> CreateMatch<T1, T2, T3, T4, T5, T6, TReturn>(Func<ICase<T1, T2, T3, T4, T5, T6, TReturn>, TReturn> match) => Item => match(Item.Match<TReturn>());

		public static Func<Union<T1, T2, T3, T4, T5, T6, T7>, TReturn> CreateMatch<T1, T2, T3, T4, T5, T6, T7, TReturn>(Func<ICase<T1, T2, T3, T4, T5, T6, T7, TReturn>, TReturn> match) => Item => match(Item.Match<TReturn>());

		public static Func<Union<T1, T2, T3, T4, T5, T6, T7, T8>, TReturn> CreateMatch<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>(Func<ICase<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>, TReturn> match) =>
			Item => match(Item.Match<TReturn>());
	}
}